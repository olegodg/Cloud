...
@Slf4j
public class MassageHandler extends SimpleChannelInboundHandler<Message> {
    private final BDAuthentificationProvider authenticationProvider;
    private FilesUtils filesUtils;

    public MassageHandler(BDAuthentificationProvider authenticationProvider) {
